  ...
  const testimonials = [
    {
      ...
      content:
        "FINALLY! A TOOL THAT DOESN'T FORCE ME INTO BORING TEMPLATES. MY SITES LOOK LIKE PURE DIGITAL ANARCHY.",
      rating: 5,
      color: "lime-400",
      rotation: -3,
      image:
    ...
    },
    {
      ...
      content:
        "QuickBuilder BROKE ALL MY PRECONCEPTIONS. NOW I BUILD WEBSITES THAT MAKE PEOPLE STOP AND STARE.",
      rating: 5,
      color: "pink-500",
      rotation: 2,
      image:
    ...
    },
    {
      ...
      company: "CHAOS CORP",
      content:
        "CONVENTIONAL BUILDERS ARE DEAD. THIS IS THE FUTURE. BRUTAL, FAST, PERFECT.",
      rating: 5,
      color: "orange-500",
      rotation: -1,
      image:
          ...
          <AnimatePresence mode='wait'>
            <motion.div
              ...
              initial={{
                opacity: 0,
                y: 100,
                rotate: testimonials[activeTestimonial].rotation * 2,
              }}
              animate={{
                opacity: 1,
                y: 0,
                rotate: testimonials[activeTestimonial].rotation,
              }}
              exit={{
                opacity: 0,
                y: -100,
            ...
            >
              <div
                className={`bg-black border-4 border-${testimonials[activeTestimonial].color} p-12 relative overflow-hidden`}
              >
                {/* Background Pattern */}
                <motion.div
                  ...
                  <div className='flex flex-col md:flex-row items-center justify-center gap-8'>
                    ...
                    >
                      <div className='text-center'>
                        <div
                          className={`text-2xl font-black text-${testimonials[activeTestimonial].color}`}
                        >
