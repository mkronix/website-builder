...
const mergeTheme = (templateTheme: Theme, currentTheme?: Theme): Theme => {
    return {
        primary_color: templateTheme.primary_color || currentTheme?.primary_color || '#3B82F6',
        secondary_color: templateTheme.secondary_color || currentTheme?.secondary_color || '#8B5CF6',
        accent_color: templateTheme.accent_color || currentTheme?.accent_color || '#F59E0B',
        text_primary: templateTheme.text_primary || currentTheme?.text_primary || '#1F2937',
        text_secondary: templateTheme.text_secondary || currentTheme?.text_secondary || '#6B7280',
        background: templateTheme.background || currentTheme?.background || '#FFFFFF',
